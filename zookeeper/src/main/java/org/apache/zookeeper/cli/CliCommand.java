 ...
 */
//--CreateCommand--执行create命令
//--DeleteCommand--执行delete命令
//--GetAclCommand--获取datanode的acl
//--GetCommand--获取datanode的数据
//--SetCommand--设置datanode的数据
//--StatCommand--获取datanode的状态属性
//--LsCommand--获取datanode的子路径属性
//--SyncCommand--持久化datanode到磁盘
