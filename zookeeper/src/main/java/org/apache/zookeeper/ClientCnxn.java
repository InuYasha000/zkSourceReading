...
public class ClientCnxn {
    ...
    class EventThread extends ZooKeeperThread {
       ...
       private volatile boolean isRunning = false;
        ...
        //10--根据改通知事件，从zkwatchermanager中取出所有相关的watcher
    ...
    protected void finishPacket(Packet p) {
        ...
        //客户端请求制定watcher，生成watcherEvent事件放入队列，等到eventThread处理？？
    ...
    class SendThread extends ZooKeeperThread {
        ...
        private void startConnect(InetSocketAddress addr) throws IOException {
            ...
            //1---建立TCP连接之后，客户端发送ConnectRequest请求，申请建立session关联，
            // 此时服务器端会为该客户端分配sessionId和密码，同时开启对该session是否超时的检测
            //--把该请求放到outgoingQueue请求队列中，等待被发送给服务器。
            //1--委托给clientCnxnSocket建立和zk服务器的tcp连接
