...
public interface Watcher {
     ...
     */
    //9--两种事件类型 KeeperState和EventType
    @InterfaceAudience.Public
    public interface Event {
        ...
        public enum KeeperState {
             ...
             */
            ConnectedReadOnly (5),//9--客户端连接后只读，无权写

            /**
              * SaslAuthenticated: used to notify clients that they are SASL-authenticated,
              * so that they can perform Zookeeper actions with their SASL-authorized permissions.
              */
            SaslAuthenticated(6),//9--认证过
        ...
        public enum EventType {
            None (-1),//--建立连接
            NodeCreated (1),//--创建节点， 节点一般指一个zk目录
            NodeDeleted (2),//--节点删除
            NodeDataChanged (3),//--节点数据该表
            NodeChildrenChanged (4),//--子节点改变
            DataWatchRemoved (5),//--观察者移除事件
            ChildWatchRemoved (6);
     ...
     */
    //9--1：子节点发生变化，2：节点关联数据发生变化，3：其它变化类型
    @InterfaceAudience.Public
